	...
	<div class="container mt-5">
		...
		<div class="my-5 col-12 col-md-6">
			...
			<?php
				if (isset($_POST['simpan'])) {
					...
					if ($nama == '' || $kategori == '' || $harga == '') {
						...
						// "gausah pake transaction" -cara fajar, membuat toko online dinamis menggunakan php mysql & bootstrap part 5 @ ~2:08:40
			...
			<?php
									...
									$queryUpdate = mysqli_query($con, "UPDATE produk SET foto='$random_name' WHERE id='$id'");
			...
			?>
										...
										<meta http-equiv="refresh" content="2; url=produk-detail.php">
			<?php
									} else {
